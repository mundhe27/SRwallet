...
class ViewDepositFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_view_deposit, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val allDeposit = ArrayList<Deposit>()
        val depositAdapter = ViewDepositAdapter(allDeposit,requireContext(),0)
            ...
            override fun onResponse(
                ...
                if(response.isSuccessful)
                {
                    ...
                    for (i in response.body()!!.deposit) {
                        if(i.deposit_type.equals("Recurring",ignoreCase = true))
                        allDeposit.add(
                            Deposit(
                                i.userId,
                                i.deposit_amount,
